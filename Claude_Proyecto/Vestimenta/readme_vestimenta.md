...
- **🏠 Inicio** (`renderInicio()`) — filosofía de guardarropa cápsula ("con 8 básicos + 6 chaquetas + 6 zapatos + 5 accesorios ya cubres las 5 ocasiones") y **plan de compra por fases** (`FASES`, 4 tarjetas) — mismo lenguaje de "fases" que el Plan Maestro de `Coach/Coach_v2.html`, a propósito, para que se sienta consistente con cómo Adán ya planea su dinero. Explícitamente conecta con su prioridad actual de liquidar deuda antes de comprar ropa de golpe.
