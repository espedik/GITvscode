...
- **🛒 Lista del Súper** — lista consolidada y deduplicada de los 38 ingredientes únicos que se necesitan para poder cocinar las 28 recetas, agrupada en 6 categorías, con checklist persistente. (El Plan Masa Muscular usa sus propios alimentos, no incluidos en esta lista — son ingredientes básicos genéricos, no una receta con cantidades exactas.)
