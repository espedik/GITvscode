...
2. **Rutina Muscular** (`salud.html` → sección "🥩 Rutina Muscular"): la meta nutricional real de Adán (75 kg, 1.78 m, 31 años, objetivo ganar masa muscular) es ~2,835 kcal y ~183 g de proteína al día. Los macros de cada receta (`r.macros`) apuntan a que desayuno + cena cubran una parte sustancial de esa meta, dejando el resto a la comida de mediodía (fuera del alcance de esta app).
