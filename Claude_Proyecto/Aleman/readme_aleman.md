...
| Pestaña | Qué es |
|---|---|
| 📖 Diccionario | Las 603 palabras en tarjetas, agrupadas por subsección |
...
|---|---|---|
| `vocab-datos.js` | Las 603 palabras en 23 secciones y **114 subsecciones**, más el Partizip | Al añadir o corregir vocabulario |
...
objetivo es pasar de 603 palabras a varios miles y una lista de 300 no se navega.
...
| `esEx` | La traducción del ejemplo. Las 603 la tienen |

**Añadir una sección entera** es lo mismo con una entrada más en `cats`: su etiqueta, su
emoji y sus `subs`. Así entraron **Hobbies** (59 palabras en 8 subsecciones) y **Armar
frases** (65 en 6).
...
**Por qué tarjetas y no una tabla.** La tabla mostraba **9 palabras** de 603 a 1600px y en el
