...
| `Aleman/` | 35+ páginas | Estudio A1/A2. Aloja el vocabulario entero (`vocab-datos.js` + `vocab.css` + `vocab.js`), que el Dashboard carga | 1.071 palabras en 23 secciones + Partizip |
